...
- Added concurrency guard preventing redundant sync calls during rapid app transitions.
- DEV-only notification test harness (5s / 30s scheduling, cancel-all utility).
